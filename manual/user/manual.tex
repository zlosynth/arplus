...
% To change the default CV mapping, first enter the configuration menu by holding
% the GROUP and SCALE buttons for 3 seconds. When the menu is opened, the LEDs
% will blink in an alternating pattern. Once in the configuration menu, turn knobs
