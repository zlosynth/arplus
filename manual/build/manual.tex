...
\posttitle{%
  \\
  \vspace{2cm}
  \includegraphics[width=16cm]{diagram-schema.pdf}
  \end{center}
}
...
\begin{tabular}{@{}rl@{}}
  ...
  4 \texttimes & Green D-shaped potentiometer, nut and washer \\
  3 \texttimes & Blue trim potentiometer \\
  6 \texttimes & Tactile button \\
  10 \texttimes & 3.5mm jack socket, nut and washer \\
  8 \texttimes & Red LED \\
...
\begin{enumerate}
  ...
  \item Place the 4 green D-shaped potentiometers in ``Green pot''
    ...
    snap the pot in.
  \item Similarly, place the 3 blue trimmer potentiometers in the ``Blue pot''
    footprints.
...
\begin{enumerate}
  ...
  \item Use tweezers to align each button. About 2 mm of it should be
    sticking out of the panel. Test that it can be easily clicked and
    returns to its resting position. If it does not, angle its body.
  \item Once the button is in a satisfying position, solder its legs.
\end{enumerate}
